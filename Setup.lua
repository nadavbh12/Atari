...
function Setup:parseOptions(arg)
  ...
  cmd:option('-mk_p1_char', 'cage', 'player1 character for MK game (cage|kano|sub-zero|sonya|rayden|liu-kang|scorpion)')
  cmd:option('-mk_p2_char', 'scorpion', 'player2 character for MK game (cage|kano|sub-zero|sonya|rayden|liu-kang|scorpion)')
  cmd:option('-mk_opponent_char', 0, 'opponent character for MK, and int between 0 and 4')
